...
function addAccount(data) {
    ...
    div.id = data.uuid;
    div.innerHTML = `
        <img class="account-image" src="https://mc-heads.net/head/${data.name}.png">
...
function headplayer(pseudo) {
    document.querySelector(".player-head").style.backgroundImage = `url(https://mc-heads.net/head/${pseudo}.png)`;
}